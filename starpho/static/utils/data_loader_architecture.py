...
base_images_path = r'/home/hadoop/Pictures/images_train//'
ava_dataset_path = r'/home/hadoop/Documents/ava_train.txt'
...
with open(ava_dataset_path, mode='r') as f:
    ...
    for i, line in enumerate(lines):
        ...
        if i % count == 0 and i != 0:
            print('Loaded %d percent of the dataset' % (i / 245000. * 100))
